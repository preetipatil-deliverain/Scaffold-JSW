...
And verify if assets for "Table 7" for "DEVIAKURICHI" are updated
And verify if assets for "Table 8" for "CUDDALORE" are updated
Then verify "Switchyard Hourly log" Asset "Table 1" is displayed on logsheet page and save in excel
Then verify "Switchyard Hourly log" Asset "Table 2" is displayed on logsheet page and save in excel
Then verify "Switchyard Hourly log" Asset "Table 3" is displayed on logsheet page and save in excel
Then verify "Switchyard Hourly log" Asset "Table 4" is displayed on logsheet page and save in excel
Then verify "Switchyard Hourly log" Asset "Table 5" is displayed on logsheet page and save in excel
Then verify "Switchyard Hourly log" Asset "Table 6" is displayed on logsheet page and save in excel
Then verify "Switchyard Hourly log" Asset "Table 7" is displayed on logsheet page and save in excel
Then verify "Switchyard Hourly log" Asset "Table 8" is displayed on logsheet page and save in excel
