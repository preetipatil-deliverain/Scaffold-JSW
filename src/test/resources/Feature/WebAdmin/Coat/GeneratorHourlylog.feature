...
Then verify "Generator Hourly Log" Asset "Table 1" is displayed on logsheet page and save in excel
Then verify "Generator Hourly Log" Asset "Table 2" is displayed on logsheet page and save in excel
Then verify "Generator Hourly Log" Asset "Table 3" is displayed on logsheet page and save in excel
Then verify "Generator Hourly Log" Asset "Table 4" is displayed on logsheet page and save in excel
Then verify "Generator Hourly Log" Asset "Table 5" is displayed on logsheet page and save in excel
Then verify "Generator Hourly Log" Asset "Table 6" is displayed on logsheet page and save in excel
Then verify "Generator Hourly Log" Asset "Table 7" is displayed on logsheet page and save in excel
Then verify "Generator Hourly Log" Asset "Table 8" is displayed on logsheet page and save in excel
Then verify "Generator Hourly Log" Asset "Table 9" is displayed on logsheet page and save in excel
