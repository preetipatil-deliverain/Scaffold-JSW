Feature: 24 Hr Log Setup - Boiler DCS Setup

Scenario: Verification of 24 Hr Boiler DCS Log Setup
...
And I select "24 Hours - Boiler DCS" as the option for update
And I verify if "24 Hours - Boiler DCS" is selected in the drop down
...
#And Enter assets for "Table 1" for "24 Hours- Boiler DCS General"
#And Enter assets for "Table 2" for "Turbine General 1"
#Then Click on Save and Continue button
#And verify if assets for "Table 1" for "24 Hours- Boiler DCS General" are updated
#And verify if assets for "Table 2" for "Turbine General 1" are updated
Then verify "24 Hours - Boiler DCS" Asset "Table 1" is displayed on logsheet page and save in excel
Then verify "24 Hours - Boiler DCS" Asset "Table 2" is displayed on logsheet page and save in excel                                                                                                            
