Feature: 24 Hr Log Setup -Switchyard (PLCC) Setup

Scenario Outline: Verification of 24 Hours- Switchyard (PLCC)
...
And I select "24 Hours- Switchyard (PLCC)" as the option for update
And I verify if "24 Hours- Switchyard (PLCC)" is selected in the drop down
...
And Enter assets for "Table 1" for "24 Hours- Switchyard General"
And Enter assets for "Table 2" for "HVAC Compressor3"
Then Click on Save and Continue button
And verify if assets for "Table 1" for "24 Hours- Boiler DCS General" are updated
And verify if assets for "Table 2" for "HVAC Compressor3" are updated
Then verify "24 Hours- Switchyard (PLCC)" Asset "Table 1" is displayed on logsheet page and save in excel
Then verify "24 Hours- Switchyard (PLCC)" Asset "Table 2" is displayed on logsheet page and save in excel                                                                                                          
