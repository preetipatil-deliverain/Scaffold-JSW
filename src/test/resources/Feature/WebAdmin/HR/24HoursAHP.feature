@Batch1
Feature: 24 Hr Log Setup - AHP Setup

Scenario: Verification of 24 Hr AHP Log Setup
...
And I select "24 Hours- AHP" as the option for update
And I verify if "24 Hours- AHP" is selected in the drop down
...
And Enter assets for "Table 1" for "24 Hours- AHP General"
Then Click on Save and Continue button
And verify if assets for "Table 1" for "24 Hours- AHP General" are updated
And verify "24 Hours- AHP General" Asset "Table 1" is displayed on logsheet page and save in excel                                                                                                         
