...
Scenario: Verification of 24 Hours- Switchyard (PLCC)
...
And verify if assets for "Table 1" for "24 Hours- Switchyard General" are updated
Then verify "24 Hours- Switchyard General" Asset "Table 1" is displayed on logsheet page and save in excel                                                                                                       
