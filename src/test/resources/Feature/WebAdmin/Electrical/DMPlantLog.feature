...
Then verify "DM Plant Log" Asset "Table 10" is displayed on logsheet page and save in excel
Then verify "DM Plant Log" Asset "Table 11" is displayed on logsheet page and save in excel
Then verify "DM Plant Log" Asset "Table 12" is displayed on logsheet page and save in excel
Then verify "DM Plant Log" Asset "Table 13" is displayed on logsheet page and save in excel
Then verify "DM Plant Log" Asset "Table 14" is displayed on logsheet page and save in excel
Then verify "DM Plant Log" Asset "Table 15" is displayed on logsheet page and save in excel
